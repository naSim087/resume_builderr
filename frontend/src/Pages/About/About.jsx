...
const testimonials = [
    ...
    {
        name: 'Nasim Sheikh',  // New testimonial
        role: 'Full Stack Developer',
        content:
            'This platform helped me build a comprehensive resume with ease, making my professional profile stand out. It’s highly customizable, and I can update it as needed for different job applications.',
        avatar:
            'https://media.licdn.com/dms/image/v2/D5603AQGrc2c0sHESrQ/profile-displayphoto-shrink_400_400/profile-displayphoto-shrink_400_400/0/1684325150236?e=1737590400&v=beta&t=1-I6Q7PwSn-xO79qjcfWkLY0tyVPdQi1TjFIkRF5HmM',  // Replace with the actual avatar URL
    },
    {
        name: 'Chetan',  // New testimonial for Chetan
        role: 'Backend Developer',
        content:
            'The resume builder made it incredibly simple to format my skills and experiences in a professional way. It saved me a lot of time and effort, making my job application process much easier.',
        avatar:
            'https://media.licdn.com/dms/image/v2/D4D03AQFXh0Z0nmorpQ/profile-displayphoto-shrink_400_400/profile-displayphoto-shrink_400_400/0/1727008475864?e=1737590400&v=beta&t=AhytvIQIaasS5y6Z7eUWS1JlzwNTOL23ufcc16HB6TQ',  // Replace with Chetan’s actual avatar URL
    }
];
